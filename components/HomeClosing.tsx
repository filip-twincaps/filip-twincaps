...
/**
 * Block 5 — the closing B2B moment. A generous, asymmetric band rather than a
 * centered CTA, so the homepage ends like a campaign page, not a form prompt.
 */
export default function HomeClosing() {
  return (
    <section className="rule-top px-6 py-28 sm:px-8 sm:py-32 lg:py-40">
        ...
        <Reveal>
          <div className="grid gap-12 lg:grid-cols-[1.3fr_0.7fr] lg:items-end lg:gap-16">
            <div>
              ...
              <h2 className="mt-7 max-w-2xl font-serif text-[clamp(2.1rem,4.8vw,4rem)] font-medium leading-[1.02] tracking-[-0.02em] text-cream text-balance">
